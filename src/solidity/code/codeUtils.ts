...
export function nameOpCodes(raw: Buffer, hardfork: string) {
  const common = new Common({ chain: 'mainnet', hardfork });
  const opcodes: any = getOpcodesForHF(common).opcodes;
 ...
 */
export function parseCode(raw: any) {
